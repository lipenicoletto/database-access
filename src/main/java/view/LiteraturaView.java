 ...
 * @author lipen
 */
public class LiteraturaView extends javax.swing.JFrame {

    /**
     * Creates new form LiteraturaVie
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LiteraturaView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LiteraturaView().setVisible(true);
            }
        });
    }
